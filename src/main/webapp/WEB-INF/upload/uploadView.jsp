...
<body>
	<table border ="1">
		<tr>
			...
			<td style="text-indent : 15px;">번호 : ${userUploadDTO.seq }</td>
		</tr>
		
		<tr>
			<td width="250" style="text-indent : 15px;">상품명 :  ${userUploadDTO.imageName }</td>
		</tr>
		
		<tr>
			<td style="text-indent : 15px;">파일명 :  ${userUploadDTO.imageOriginalFileName }</td>
		</tr>
